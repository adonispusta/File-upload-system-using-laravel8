...
class StorageManager
{
    ...
    {
        return $this->disk($isPrivate)->exists($type . DIRECTORY_SEPARATOR . $name);
    }

    public function getFile(string $name , string $type , bool $isPrivate)
    {
        return $this->disk($isPrivate)->download($type . DIRECTORY_SEPARATOR . $name);
    }

    public function deleteFile(string $name , string $type , bool $isPrivate)
    {
        return $this->disk($isPrivate)->delete($type . DIRECTORY_SEPARATOR . $name);
    }
